...
//MPU6050 sensor has many functions over the single chip. 
//It consists a MEMS accelerometer, a MEMS gyro, and temperature sensor.
//This module is very accurate while converting analog values to digital because it has a 16bit analog to digital converter hardware for each channel.
//This module is capable to capture x, y and z channel at the same time. 
//It has an I2C interface to communicate with the host controller. This MPU6050 module is a compact chip having both accelerometer and gyro. 
//This is a very useful device for many applications like drones, robots, motion sensors. 
//It is also called Gyroscope or Triple axis accelerometer.
//MPU6050 gyro and accelerometer both are used to detect the position and orientation of any device. 
